<html>
<head>
<title>Presidency Election</title>
<style type="text/css">
.overlay {
  width: 50%;
  height: 20%;
...
<img src=pre.png float="left" alt="presidency Election" width="500" height="200">
...
<a href="vote.php"><button type="submit"> Login</button></a>
</form>
